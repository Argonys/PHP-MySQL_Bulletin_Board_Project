	...
	<nav class="navbar navbar-default navbar-expand-lg navbar-light">
		...
		<div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
			...
			<ul class="nav navbar-nav navbar-right ml-auto">
				<li class="nav-item">
					<a data-toggle="dropdown" class="nav-link dropdown-toggle" href="#">Profile <b class="caret"></b></a>
					<ul class="dropdown-menu">
						<li><a href="profile.php" class="dropdown-item">Paramètres</a></li>
				...
				<li class="nav-item"><a href="index.php?logout='true'" class="btn btn-primary mt-1 mb-1">Log out</a></li>
			</ul>
		</div>
	</nav>
</body>
